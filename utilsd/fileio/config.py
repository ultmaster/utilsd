# This file is modified from https://github.com/open-mmlab/mmcv/blob/master/mmcv/utils/config.py
...
class Config:
    ...
    def _file2dict(filename, use_predefined_variables=True):
        ...
        with tempfile.TemporaryDirectory() as temp_config_dir:
            ...
            if filename.endswith('.py'):
                ...
                cfg_dict = mmcv_load(temp_config_file.name)
            # close temp file
            temp_config_file.close()
    ...
    def __init__(self, cfg_dict=None, cfg_text=None, filename=None):
        ...
        # cast to string if a path from pathlib
    ...
    def dump(self, file=None):
        ...
        if self.filename.endswith('.py'):
            ...
            if file is None:
                ...
                return mmcv_dump(cfg_dict, file_format=file_format)
            else:
                mmcv_dump(cfg_dict, file)
